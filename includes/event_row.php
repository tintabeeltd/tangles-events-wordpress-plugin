<div class="event_row_container">
	<div class="event_row_date">
		...
		<?php if (!empty($event->logo_url)) {?>
			<button type="button" class="btn-logo-sm" style="background-image:url('<?php echo esc_attr($event->logo_url) ?>')"></button>
		<?php } else {?>
			<button type="button" class="btn-logo-sm"><?php echo tangles_events_get_ident($event->name) ?></button>
		<?php }?>
	</div>
	<div class="event_row_body">
		<h4 class="event_row_title"><?php echo esc_attr($event->name); ?></h4>
			...
			<div class="event_row_block">
		 		<span class="event_row_img_calendar"></span>
				<span class="event_row_block_body"><?php echo tangles_events_end_date_summary($event->end_date) ?></span>
			</div>
	...
	<div class="event_row_image_container">
		<a href="<?php echo $event->featured; ?>" >
			...
			<img src="<?php echo esc_attr($event->featured) ?>" class="event_row_image"/>
			<?php } else {?>			
